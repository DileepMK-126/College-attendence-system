...
Add student face images to the `dataset/` folder
Image naming format: `StudentName.jpg` or `StudentName.png`
Example: `JohnDoe.jpg`, `JaneSmith.png`
Important:
...
Face recognition window will open
Students face the camera for automatic attendance
Press 'q' in the recognition window to stop
